...
/datum/export/material/f13cash
	cost = 10
	message = ""
	unit_name = "bottle cap"
	material_id = /datum/material/f13cash
	export_types = list(/obj/item/stack/f13Cash/caps)

/datum/export/material/f13cash/scrip
	cost = 6 // They like people using their money because economics or something; 1 copper = 2 scrip; if abused again, set to 5
	unit_name = "NCR dollar"
